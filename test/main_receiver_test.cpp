...
int main(){
    ...
    const char * i_input_data_control = "../input_data/receiver_input_test.txt";
    ...
    dynamic::modeling::Models submodels_TOP = {input_reader, receiver1};
    dynamic::modeling::EICs eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP = {
        dynamic::translate::make_EOC<Receiver_defs::out,outp>("receiver1")
    };
    dynamic::modeling::ICs ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<Message_t>::out,Receiver_defs::in>("input_reader","receiver1")
    };
