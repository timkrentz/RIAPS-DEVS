...
int main(){
    ...
    */
    ...
    component1Ports.push_back(PortDescription_t{"TimerHandler1","","intTimerTopic", TIMER, 100});
    ...
    shared_ptr<dynamic::modeling::model> zmq1 = dynamic::translate::make_dynamic_atomic_model<ZMQContext,TIME>("zmq1",component1Ports);
    ...
    dynamic::modeling::ICs ics_TOP = {
        ...
        dynamic::translate::make_IC<ZMQContext_defs::fromComp,Component_defs::zmqOut>("zmq1","component1"),
    };
